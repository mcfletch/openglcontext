...
class TestContext( BaseContext ):
    ...
    def OnInit( self ):
        ...
        print """You should see a cylinder over a black background
    The cylinder should have a mapped texture (a stained-glass window)
...
"""
    ...
    def OnSizeSwitch( self, event=None ):
        ...
        self.shape.geometry.radius = newSize
