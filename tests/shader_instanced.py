#! /usr/bin/env python
'''=Instanced Geometry and Texture Buffer Extensions (Legacy GLSL)=

[shader_instanced.py-screen-0001.png Screenshot]

This tutorial demonstrates instanced geometry rendering using legacy GLSL
syntax (pre-1.40). For modern GLSL (1.40+), see shader_instanced_modern.py.
