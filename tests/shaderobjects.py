        ...
        [
            ...
            GLSLObject(
                uniforms=[
                    ...
                    FloatUniform2f(
                        name="Center", value=(-0.64870076, 0.42840204), DEF="MAND_CENT"
                    ),
                ...
                shaders=[
                    GLSLShader(url="./resources/CH18-mandel.vert.txt", type="VERTEX"),
                    GLSLShader(url="./resources/CH18-mandel.frag.txt", type="FRAGMENT"),
                ],
            ),
            GLSLObject(
                uniforms=[],
