...
def banked_sections(sections: Any, bank: Any,
    ...
    **How far the carriageway reaches is read off the cut**, not off the
    profile: a stretch that has been widened to be passed on
    (:func:`widened_sections`) has its camber taken out to the edge it actually
    has rather than to the edge the road would have had if it had not widened.
    """
    profile = profile or RoadProfile()
