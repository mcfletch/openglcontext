...
- :class:`HeightField` — the elevation grid you render and walk on (height and
  slope on the surface it draws, mesh generation, baked sun/canopy shadow).
  Built from an image, or from the height function a landscape is authored as.
