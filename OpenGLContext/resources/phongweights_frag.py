...
data = (
    ...
    b'     // is a spot...\n            float spot_cos = dot(\n     '
    b'           normalMatrix * normalize(spot_direction.xyz),\n   '
    b'             normalize(-light_pos)\n            );\n          '
    b'  if (spot_cos <= spot_params.x) {\n                // is a s'
    b'pot, and is outside the cone-of-light...\n                ret'
    b'urn vec3( 0.0, 0.0, 0.0 );\n            } else {\n            '
    b'    if (spot_cos == 1.0) {\n                    spot_effect ='
    b' 1.0;\n                } else {\n                    spot_effe'
    b'ct = pow( \n                        (1.0-spot_params.x)/(1.0-'
    b'spot_cos), \n                        spot_params.y \n         '
    b'           );\n                }\n            }\n        }\n    '
    b'    n_dot_half = pow(\n            max(0.0,dot( \n            '
    ...
    b'                   (attenuations.z * distance * distance)\n  '
    b'              );\n            attenuation = clamp( attenuatio'
    b'n, 0.0, 1.0 );\n            n_dot_pos *= attenuation;\n       '
    b'     n_dot_half *= attenuation;\n        }\n    }\n    return v'
    b'ec3( attenuation, n_dot_pos, n_dot_half);\n}\n'
)
