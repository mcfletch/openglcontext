...
The idea of this module is to allow you to watch for
unexpected changes across complex code hierarchies.

It is particularly useful if you have a single pass
of your renderer operating correctly, but all
subsequent passes fail.  Instantiating a State
object on the first pass, then using its diff
method on a State instantiated during the second
pass will return a dictionary with the changed
