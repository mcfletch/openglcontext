entry_points = {
    ...
    'Node': [
        ...
        'Extrusion = OpenGLContext.scenegraph.extrusions:Extrusion',
        ...
        'PolyCone = OpenGLContext.scenegraph.extrusions:PolyCone',
        'PolyCylinder = OpenGLContext.scenegraph.extrusions:PolyCylinder',
